...
import com.ionexchange.databinding.FragmentTimerIndexBinding;
...
// created by Silambu
public class FragmentTimerIndex extends Fragment implements RvOnClick {
    FragmentTimerIndexBinding mBinding;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_timer_index, container, false);
